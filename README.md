...
- We would be delighted to hear from you if you find GMMV-LIM useful, or if you have any suggestions, contributions, or bug reports. Please send these to Shilong Sun (shilongsun@126.com)


Citation
--------

- [*A Linear Model for Microwave Imaging of Highly Conductive Scatterers*](https://arxiv.org/abs/1906.10900), S. Sun, B. J. Kooij, and A. G. Yarovoy, IEEE Transactions on Microwave Theory and Techniques, 66 (3), 1149 - 1164, 2018

- [*A linear method for shape reconstruction based on the generalized multiple measurement vectors model*](https://arxiv.org/abs/1906.10875), S. Sun, B. J. Kooij, A. G. Yarovoy, and T. Jin, IEEE Transactions on Antennas and Propagation, 66 (4), 2016-2025, 2018
